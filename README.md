...
### 📍 5. Ubah Lokasi Google Maps

Di `index.html` section "Kontak":
```html
<!-- Sebelum -->
<a href="https://goo.gl/maps/EkEo8QiBiVqE8Qzr5">Lihat Peta</a>

<!-- Sesudah (ganti dengan link Google Maps Anda) -->
<a href="https://goo.gl/maps/YOURMAPSLINK">Lihat Peta</a>
```

### 🌐 6. Edit Social Media Links

Di `index.html` section "Ikuti Kami":
```html
...
### 🎮 Alvaro PlayStation
**Informasi Bisnis & Support**

| Platform | Contact |
|----------|---------|
| 💬 WhatsApp | [+62 822-6508-1432](https://wa.me/6282265081432) |
| 📧 Email | caesarrenaldi@gmail.com |
| 📍 Lokasi | [Yogyakarta, Indonesia](https://goo.gl/maps/EkEo8QiBiVqE8Qzr5) |
| 🌐 Instagram | [@renaldican_](https://www.instagram.com/renaldican_) |
| 🎵 TikTok | [@renaldican_](https://www.tiktok.com/@renaldican_) |
| 📺 YouTube | [@renaldican_](https://youtube.com/@renaldican_) |
| 𝕏 Twitter/X | [@RENALDICAN_](https://x.com/RENALDICAN_) |
| 👍 Facebook | [Renaldi Can](https://www.facebook.com/share/1DsjaKmTgf/) |
